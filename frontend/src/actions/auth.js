...
export const checkAuthenticated = () => async dispatch => {
    ...
    try {
        const res = await axios.get(`${process.env.REACT_APP_API_URL}/account/authenticated`, config);
...
export const logout = () => async dispatch => {
    ...
    try {
        const res = await axios.post(`${process.env.REACT_APP_API_URL}/account/logout`, body, config);
